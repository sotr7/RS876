...
public final class IsaacCipher {
	...
	final void method605() {
		...
		for (int var1 = 0; var1 < 256; ++var1) {
			...
			int var3;
			this.anIntArray158[var1] = var3 = 1345211677 * this.anInt164
					+ this.anIntArray158[(var2 & 1020) >> 2] + 784744307
					* this.anInt163;
	...
	final void method608(int var1) {
		...
		for (int var2 = 0; var2 < 256; ++var2) {
			...
			int var4;
			this.anIntArray158[var2] = var4 = 1345211677 * this.anInt164
					+ this.anIntArray158[(var3 & 1020) >> 2] + 784744307
					* this.anInt163;
