...
public class Class153_Sub1_Sub1 extends Class153_Sub1 {
         ...
         if(anInt8933 == 0) {
            if(anInt8947 == 0) {
               for(var6 = anInt8943; var6 < 0; anInt8945 += anInt8929) {
                  ...
                  if(var7 >= 0) {
                     ...
                     if(var9 >= 0 && var10 >= 0 && var9 - (this.anInt8936 << 12) < 0 && var10 - (this.anInt8944 << 12) < 0) {
                        ...
                        while(var11 < 0) {
                           var15 = this.anIntArray11342[(var10 >> 12) * this.anInt8936 + (var9 >> 12)];
                           var16 = var15 >>> 24;
                           var17 = 256 - var16;
                           var18 = var5[var8];
               ...
               for(var6 = anInt8943; var6 < 0; anInt8945 += anInt8929) {
                  ...
                  if(var7 >= 0) {
                     ...
                     if(var9 >= 0 && var9 - (this.anInt8936 << 12) < 0) {
                        if((var19 = var10 - (this.anInt8944 << 12)) >= 0) {
                           var19 = (anInt8947 - var19) / anInt8947;
                           var11 += var19;
                           var10 += anInt8947 * var19;
                           var8 += var19;
                        }

                        if((var19 = (var10 - anInt8947) / anInt8947) > var11) {
                           var11 = var19;
                        }
               ...
               for(var6 = anInt8943; var6 < 0; anInt8945 += anInt8929) {
                  ...
                  if(var7 >= 0) {
                     ...
                     if(var9 >= 0 && var9 - (this.anInt8936 << 12) < 0) {
                        if(var10 < 0) {
                           var19 = (anInt8947 - 1 - var10) / anInt8947;
                           var11 += var19;
                           var10 += anInt8947 * var19;
                           var8 += var19;
                        }

                        if((var19 = (1 + var10 - (this.anInt8944 << 12) - anInt8947) / anInt8947) > var11) {
                           var11 = var19;
                        }
               ...
               for(var6 = anInt8943; var6 < 0; anInt8945 += anInt8929) {
                  ...
                  if(var7 >= 0) {
                     ...
                     if(var10 >= 0 && var10 - (this.anInt8944 << 12) < 0) {
                        if((var19 = var9 - (this.anInt8936 << 12)) >= 0) {
                           var19 = (anInt8933 - var19) / anInt8933;
                           var11 += var19;
                           var9 += anInt8933 * var19;
                           var8 += var19;
                        }

                        if((var19 = (var9 - anInt8933) / anInt8933) > var11) {
                           var11 = var19;
                        }
            ...
            for(var6 = anInt8943; var6 < 0; anInt8945 += anInt8929) {
               ...
               if(var7 >= 0) {
                  ...
                  if(var10 >= 0 && var10 - (this.anInt8944 << 12) < 0) {
                     if(var9 < 0) {
                        var19 = (anInt8933 - 1 - var9) / anInt8933;
                        var11 += var19;
                        var9 += anInt8933 * var19;
                        var8 += var19;
                     }

                     if((var19 = (1 + var9 - (this.anInt8936 << 12) - anInt8933) / anInt8933) > var11) {
                        var11 = var19;
                     }
   ...
   public void method1782(int var1, int var2, int var3, int var4, int[] var5, int var6, int var7) {
      ...
      for(int var8 = 0; var8 < var4; ++var8) {
         ...
         for(int var10 = 0; var10 < var3; ++var10) {
            this.anIntArray11342[var9 + var10] = var5[var6++];
         }
   ...
   Class153_Sub1_Sub1(Class174_Sub1 var1, int[] var2, int var3, int var4, int var5, int var6, boolean var7) {
      super(var1, var5, var6);
      if(var7) {
         this.anIntArray11342 = new int[var5 * var6];
      } else {
         this.anIntArray11342 = var2;
      }
      ...
      for(int var9 = 0; var9 < var6; ++var9) {
         for(int var10 = 0; var10 < var5; ++var10) {
            this.anIntArray11342[var8++] = var2[var3++];
         }
   ...
   void method10431(int var1, int var2, int var3, int var4, int[] var5, int var6, int var7) {
      var7 -= var3;
      ...
      for(int var8 = 0; var8 < var4; ++var8) {
         ...
         for(int var10 = 0; var10 < var3; ++var10) {
            var5[var6++] = this.anIntArray11342[var9 + var10];
         }
      ...
      if(var7 == null) {
         ...
         for(int var8 = 0; var8 < var4; ++var8) {
            ...
            for(int var11 = 0; var11 < var3; ++var11) {
               this.anIntArray11342[var9 + var11] = var7[var10 + var11] & 16777215;
            }
         }
               ...
               if(var5 == 0) {
                  if(var3 == 1) {
                     for(var14 = -var10; var14 < 0; ++var14) {
                        for(var15 = var8 + var11 - 3; var8 < var15; var6[var8++] = this.anIntArray11342[var9++]) {
                           var6[var8++] = this.anIntArray11342[var9++];
                           var6[var8++] = this.anIntArray11342[var9++];
                           var6[var8++] = this.anIntArray11342[var9++];
                        }

                        for(var15 += 3; var8 < var15; var6[var8++] = this.anIntArray11342[var9++]) {
                           ;
                        }
                     ...
                     for(var17 = -var10; var17 < 0; ++var17) {
                        for(var18 = -var11; var18 < 0; ++var18) {
                           var19 = this.anIntArray11342[var9++];
                     ...
                     for(var14 = -var10; var14 < 0; ++var14) {
                        for(var15 = -var11; var15 < 0; ++var15) {
                           var16 = this.anIntArray11342[var9++];
                           var17 = var16 + var4;
                     ...
                     for(var18 = -var10; var18 < 0; ++var18) {
                        for(var19 = -var11; var19 < 0; ++var19) {
                           var20 = this.anIntArray11342[var9++];
   ...
   public void method1777(int var1, int var2, int var3) {
      int[] var4 = this.aClass174_Sub1_8932.anIntArray9243;
      if(var4 == null) {
         throw new IllegalStateException("");
      } else {
         int var5;
         ...
         int var8;
         if(var3 == 0) {
            for(var5 = 0; var5 < this.anInt8944; ++var5) {
               var6 = var5 * this.anInt8936;
               var7 = (var2 + var5) * this.aClass174_Sub1_8932.anInt9277 * -2145294317 + var1;

               for(var8 = 0; var8 < this.anInt8936; ++var8) {
                  this.anIntArray11342[var6 + var8] = this.anIntArray11342[var6 + var8] & 16777215 | var4[var7 + var8] << 8 & -16777216;
               }
            }
         } else if(var3 == 1) {
            for(var5 = 0; var5 < this.anInt8944; ++var5) {
               ...
               for(var8 = 0; var8 < this.anInt8936; ++var8) {
                  this.anIntArray11342[var6 + var8] = this.anIntArray11342[var6 + var8] & 16777215 | var4[var7 + var8] << 16 & -16777216;
               }
            }
         } else if(var3 == 2) {
            for(var5 = 0; var5 < this.anInt8944; ++var5) {
               ...
               for(var8 = 0; var8 < this.anInt8936; ++var8) {
                  this.anIntArray11342[var6 + var8] = this.anIntArray11342[var6 + var8] & 16777215 | var4[var7 + var8] << 24 & -16777216;
               }
            }
         } else if(var3 == 3) {
            for(var5 = 0; var5 < this.anInt8944; ++var5) {
               ...
               for(var8 = 0; var8 < this.anInt8936; ++var8) {
                  this.anIntArray11342[var6 + var8] = this.anIntArray11342[var6 + var8] & 16777215 | (var4[var7 + var8] != 0?-16777216:0);
               }
            }
         }
   ...
   public Interface21 method1773() {
      return new Class108(this.anInt8936, this.anInt8944, this.anIntArray11342);
   }

   void method10432(int var1, int var2, int var3, int var4, int[] var5, int var6, int var7) {
      var7 -= var3;
   ...
   public void method1779(int var1, int var2, Class162 var3, int var4, int var5) {
      if(this.aClass174_Sub1_8932.method8494()) {
         ...
         if(var6 != null) {
            ...
            if(var9 > 0 && var10 > 0) {
               Class162_Sub2 var29 = (Class162_Sub2)var3;
               int[] var15 = var29.anIntArray9211;
               int[] var16 = var29.anIntArray9210;
               int var17 = var2;
               if(var5 > var2) {
                  var17 = var5;
               ...
               for(int var19 = var17; var19 < var18; ++var19) {
                  ...
                  for(int var24 = -var21; var24 < 0; ++var24) {
                     int var25 = this.anIntArray11342[var7++];
                     int var26 = var25 >>> 24;
                     int var27 = 256 - var26;
               ...
               if(var5 == 1) {
                  ...
                  for(var20 = -var4; var20 < 0; ++var20) {
                     ...
                     for(var22 = -var3; var22 < 0; ++var22) {
                        var9[var17++] = this.anIntArray11342[(var10 >> 16) + var21];
                        var10 += var15;
                     }
                  ...
                  for(var23 = -var4; var23 < 0; ++var23) {
                     ...
                     for(var25 = -var3; var25 < 0; ++var25) {
                        var26 = this.anIntArray11342[(var10 >> 16) + var24];
                  ...
                  for(var20 = -var4; var20 < 0; ++var20) {
                     ...
                     for(var22 = -var3; var22 < 0; ++var22) {
                        var23 = this.anIntArray11342[(var10 >> 16) + var21];
                        var24 = var23 + var6;
                  ...
                  for(var24 = -var4; var24 < 0; ++var24) {
                     ...
                     for(var26 = -var3; var26 < 0; ++var26) {
                        var27 = this.anIntArray11342[(var10 >> 16) + var25];
               ...
               if(var9 == 1) {
                  ...
                  for(var25 = -var8; var25 < 0; ++var25) {
                     ...
                     for(var27 = -var7; var27 < 0; ++var27) {
                        if(!var2 || var6 < var39[var20]) {
                           if(var1) {
                              var23[var20] = this.anIntArray11342[(var14 >> 16) + var26];
                           }
                  ...
                  for(var28 = -var8; var28 < 0; ++var28) {
                     ...
                     for(var30 = -var7; var30 < 0; ++var30) {
                        if(!var2 || var6 < var39[var20]) {
                           if(var1) {
                              var31 = this.anIntArray11342[(var14 >> 16) + var29];
                  ...
                  for(var25 = -var8; var25 < 0; ++var25) {
                     ...
                     for(var27 = -var7; var27 < 0; ++var27) {
                        if(!var2 || var6 < var39[var20]) {
                           if(var1) {
                              var28 = this.anIntArray11342[(var14 >> 16) + var26];
                              var29 = var28 + var10;
                  ...
                  for(var29 = -var8; var29 < 0; ++var29) {
                     ...
                     for(var31 = -var7; var31 < 0; ++var31) {
                        if(!var2 || var6 < var39[var20]) {
                           if(var1) {
                              var32 = this.anIntArray11342[(var14 >> 16) + var30];
   ...
   void method10433(int var1, int var2, int[] var3, int var4, int var5) {
      int var6;
      int var7;
      int var8;
      int var9;
      ...
      if(var5 == 0) {
         if(var4 == 1) {
            var3[var2] = this.anIntArray11342[var1];
         } else if(var4 == 0) {
            var6 = this.anIntArray11342[var1++];
         ...
         if(var5 == 1) {
            if(var4 == 1) {
               ...
               var6 = this.anIntArray11342[var1];
               var7 = (var6 >>> 24) * anInt8957 >> 8;
               var8 = 256 - var7;
               if((anInt8956 & 16777215) == 16777215) {
                  var9 = var3[var2];
                  var3[var2] = ((var6 & 16711935) * var7 + (var9 & 16711935) * var8 & -16711936) + ((var6 & '\uff00') * var7 + (var9 & '\uff00') * var8 & 16711680) >> 8;
               } else if(var7 != 255) {
                  var9 = (var6 & 16711680) * anInt8959 & -16777216;
                  var10 = (var6 & '\uff00') * anInt8960 & 16711680;
                  var11 = (var6 & 255) * anInt8964 & '\uff00';
               ...
               var7 = var6 >>> 24;
               var8 = 256 - var7;
               var9 = (var6 & 16711935) * anInt8957 & -16711936;
               var10 = (var6 & '\uff00') * anInt8957 & 16711680;
               var6 = ((var9 | var10) >>> 8) + anInt8931;
               var11 = var3[var2];
   ...
   Class153_Sub1_Sub1(Class174_Sub1 var1, int[] var2, int var3, int var4) {
   ...
   public void method1797(int var1, int var2, int var3, int var4, int[] var5, int[] var6, int var7, int var8) {
      this.method10431(var1, var2, var3, var4, var5, var7, var8);
   }
            ...
            if(anInt8947 == 0) {
               for(var4 = anInt8943; var4 < 0; anInt8945 += anInt8929) {
                  ...
                  if(var6 >= 0 && var7 >= 0 && var6 - (this.anInt8936 << 12) < 0 && var7 - (this.anInt8944 << 12) < 0) {
                     while(var8 < 0) {
                        this.method10433((var7 >> 12) * this.anInt8936 + (var6 >> 12), var5++, var3, var1, var2);
                        ++var8;
                     }
                  }
   ...
   Class153_Sub1_Sub1(Class174_Sub1 var1, int var2, int var3) {
      super(var1, var2, var3);
      this.anIntArray11342 = new int[var2 * var3];
   }
}
