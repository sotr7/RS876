...
public class Class60 {
	...
	static boolean method1037(Interface59 var0, Class40_Sub8 var1, int var2,
			int var3, byte var4) {
		if (var0 == null) {
			return false;
		} else {
			Class610 var5 = (Class610) var1.method89(var0.method56(273406506),
					-366493525);
				...
				if (null != var5.anIntArray7989) {
					for (int var7 = 0; var7 < var5.anIntArray7989.length; ++var7) {
						if (-1 != var5.anIntArray7989[var7]) {
							Class610 var8 = (Class610) var1.method89(
									var5.anIntArray7989[var7], -468087933);
	...
	static void method1038(InterfaceDef var0, Class162 var1, int var2,
			int var3, int var4, int var5, Class153 var6, int var7) {
		Class231.method3255(var0, var1, var2, var3, var4, var5, var6, 100.0D,
				Class286.aClass286_3096, Class267.aClass267_2984, 1997164371);
	}
	...
	public static void method1040(int var0, int var1, int var2) {
		Class526_Sub21_Sub9 var3 = Class265.method3560(17, (long) var1 << 32
				| (long) var0);
