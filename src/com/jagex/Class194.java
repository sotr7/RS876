...
class Class194 implements Interface40 {
	...
	public float method331() {
		return (float) Class230.preferences.aClass711_Sub29_10605
				.method10105((byte) 57) / 255.0F;
	}

	public float method332(int var1) {
		return (float) Class230.preferences.aClass711_Sub29_10605
				.method10105((byte) 101) / 255.0F;
	}

	public float method333() {
		return (float) Class230.preferences.aClass711_Sub29_10605
				.method10105((byte) 94) / 255.0F;
	}
		...
		if (Class57.aClass44_687 != null) {
			try {
				...
				if (Class57.aClass44_687 == Class44.aClass44_459) {
					client.aClass111_11059.method1366(Class45.method925(
							Class16.aClass6_179.method549(-1532818671),
							'\u9c40', -2143352821),
					...
					var2.out.writeByte(Class403.aClass403_4155.anInt4153
							* -636933581, 100626475);
					var2.out.writeShort(0, -805078716);
					var3 = var2.out.pos * 301018015;
					var2.out.writeShort(Launcher.REVISION, -805078716);
					var2.out.writeShort(Launcher.SUB_REVISION, -805078716);
					Class57.anIntArray685 = Class512.method6186(var2,
							-353791464);
					int var4 = 301018015 * var2.out.pos;
					var2.out.method9616(client.aString11002, 1427405332);
					var2.out.writeShort(-264476799 * client.anInt10985,
							-805078716);
					var2.out.writeInt(client.anInt10989 * -885338537,
							-357564953);
					...
					var2.out.writeByte(-767001605
							* client.aClass676_11127.anInt8593, 1526878562);
					...
					Class663.aClass526_Sub40_8522.method9759(var2.out,
							(byte) -11);
					var2.out.pos += 1318867609;
					var2.out.method9622(Class57.anIntArray685, var4,
							301018015 * var2.out.pos, (short) 768);
				...
				if (Class44.aClass44_460 == Class57.aClass44_687) {
					...
					if (!client.aClass111_11059.method1364(-1184311292)
							.method6727(1, -200161544)) {
						return;
					}

					client.aClass111_11059.method1364(-1184311292).read(
							client.aClass111_11059.buffer.buffer, 0, 1,
							-143347500);
					Class57.aClass693_684 = (Class693) Class561
							.findIdentifiable(
									Class390.method4776((byte) -97),
									client.aClass111_11059.buffer.buffer[0] & 255,
									(byte) -74);
					if (Class57.aClass693_684 != Class693.aClass693_8709) {
						client.aClass111_11059.method1369(2048370661);
					} else {
						client.aClass111_11059.aClass14_1342 = new IsaacCipher(
								Class57.anIntArray685);
						int[] var7 = new int[4];
						...
						client.aClass111_11059.aClass14_1340 = new IsaacCipher(
								var7);
						new IsaacCipher(var7);
						client.aClass111_11059.buffer
								.setCipher(
										client.aClass111_11059.aClass14_1340,
										438752233);
	...
	static final void method2810(Class681 var0, byte var1) {
		int var2 = var0.anIntArray8622[(var0.anInt8623 -= -1957887669)
				* -1730576285];
	...
	static final void method2811(Class681 var0, int var1) {
		var0.anIntArray8622[(var0.anInt8623 += -1957887669) * -1730576285 - 1] = 1449227059
				* client.anInt11111 - client.anInt11110 * -662273649;
	}
	...
	static final void method2813(Class681 var0, int var1) {
		...
		for (int var4 = 0; var4 < Class300.aClass448_Sub1Array3253.length; ++var4) {
			if (Class300.aClass448_Sub1Array3253[var4] != null
					&& Class300.aClass448_Sub1Array3253[var4]
							.method9204((byte) 121)) {
				var2 += Class300.aClass448_Sub1Array3253[var4]
						.method9200((byte) 0);
				var3 += Class300.aClass448_Sub1Array3253[var4]
						.method9218(1864543890);
			}
		}

		var0.anIntArray8622[(var0.anInt8623 += -1957887669) * -1730576285 - 1] = var2 == 0 ? 0
				: 100 * var3 / var2;
	}

	static final void method2814(Class681 var0, byte var1) {
		var0.anIntArray8622[(var0.anInt8623 += -1957887669) * -1730576285 - 1] = Class509
				.method6166(21851305) ? 1 : 0;
	}
