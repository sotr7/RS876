...
public abstract class Class499 implements Interface62, Runnable, FocusListener,
		WindowListener {
	...
	static void method5949() {
		try {
			...
			if (var0.exists()) {
				...
				label34: for (int var1 = 0; var1 < Class313_Sub1.aStringArray10013.length; ++var1) {
					for (var2 = 0; var2 < Class184_Sub1.aStringArray9201.length; ++var2) {
						File var3 = new File(
								Class184_Sub1.aStringArray9201[var2]
										+ Class313_Sub1.aStringArray10013[var1]
										+ File.separatorChar + "random.dat");
						if (var3.exists()) {
							aClass23_5619 = new Class23(new Class21(var3, "rw",
									25L), 24, 0);
							break label34;
						}
					}
	...
	final void method5950(String var1, String var2, int var3, int var4,
			int var5, int var6, int var7) throws Exception {
		...
		try {
			Class570.aString7658 = System.getProperty("os.version")
					.toLowerCase();
		...
		try {
			Class495.anEventQueue5540 = Toolkit.getDefaultToolkit()
					.getSystemEventQueue();
		} catch (Throwable var14) {
			;
		}

		Class184_Sub1.aStringArray9201 = new String[] { "c:/rscache/",
				"/rscache/", "c:/windows/", "c:/winnt/", "c:/",
				Class661.aString8517, "/tmp/", "" };
		Class313_Sub1.aStringArray10013 = new String[] {
				".jagex_cache_" + Class471.anInt5361 * -320214517,
				".file_store_" + Class471.anInt5361 * -320214517 };
		int var8 = 0;

		int var11;
		label131: while (var8 < 4) {
			Class199_Sub1.aFile9868 = this.method5951(var1, var2, var8,
					-1019384485);
		...
		aClass23_5595 = new Class23(new Class21(Class526_Sub24.method9481(
				"main_file_cache.dat2", 1446483889), "rw", 3221225472L), 5200,
				0);
		aClass23_5621 = new Class23(new Class21(Class526_Sub24.method9481(
				"main_file_cache.idx255", 913308700), "rw", 1048576L), 6000, 0);
		Class679.aClass23Array8603 = new Class23[120072273 * Class199.anInt2200];

		for (var8 = 0; var8 < Class199.anInt2200 * 120072273; ++var8) {
			Class679.aClass23Array8603[var8] = new Class23(new Class21(
					Class526_Sub24.method9481("main_file_cache.idx" + var8,
							21949972), "rw", 1048576L), 6000, 0);
		}
		...
		for (ThreadGroup var22 = var21.getParent(); null != var22; var22 = var22
				.getParent()) {
			var21 = var22;
		}
		...
		for (var11 = 0; var11 < var24.length; ++var11) {
			if (var24[var11] != null
					&& var24[var11].getName().startsWith("AWT")) {
	...
	File method5951(String var1, String var2, int var3, int var4) {
		...
		Class143_Sub2.aFile8965 = new File(Class661.aString8517, "jagex_cl_"
				+ var1 + "_" + var2 + var5 + ".dat");
		String var6 = null;
		String var7 = null;
		boolean var8 = false;
		File var21;
		if (Class143_Sub2.aFile8965.exists()) {
			try {
				Class21 var9 = new Class21(Class143_Sub2.aFile8965, "rw",
						10000L);

				RSByteBuffer var10;
				int var11;
				for (var10 = new RSByteBuffer((int) var9.method658((byte) -44)); var10.pos * 301018015 < var10.buffer.length; var10.pos += var11 * 801976415) {
					var11 = var9.method653(var10.buffer, var10.pos * 301018015,
							var10.buffer.length - 301018015 * var10.pos,
							(byte) 73);
					if (-1 == var11) {
		...
		if (var6 == null && 0 == var3) {
			label103: for (int var19 = 0; var19 < Class313_Sub1.aStringArray10013.length; ++var19) {
				for (int var22 = 0; var22 < Class184_Sub1.aStringArray9201.length; ++var22) {
					File var23 = new File(Class184_Sub1.aStringArray9201[var22]
							+ Class313_Sub1.aStringArray10013[var19]
							+ File.separatorChar + var1 + File.separatorChar);
					if (var23.exists()
							&& this.method5953(new File(var23, "test.dat"),
									true, -2036306055)) {
						var6 = var23.toString();
						var8 = true;
						break label103;
		...
		if (var6 == null) {
			var6 = Class661.aString8517 + File.separatorChar + "jagexcache"
					+ var5 + File.separatorChar + var1 + File.separatorChar
					+ var2 + File.separatorChar;
			var8 = true;
		}
	...
	synchronized void method5954(String var1, int var2) {
		...
		Class242.aFrame2454.setSize(Class332.anInt3505 * 1405944805 + var3.left
				+ var3.right, 542147681 * Class586.anInt7792 + var3.top
				+ var3.bottom);
	}
	...
	final boolean method5957(int var1) {
		String var2 = Class492.anApplet5526.getDocumentBase().getHost()
				.toLowerCase();
		if (!var2.equals("jagex.com") && !var2.endsWith(".jagex.com")) {
			if (!var2.equals("runescape.com")
					&& !var2.endsWith(".runescape.com")) {
				if (!var2.equals("stellardawn.com")
						&& !var2.endsWith(".stellardawn.com")) {
					if (var2.endsWith(Launcher.HOST_ADDRESS))
						return true;
					else {
						while (var2.length() > 0
								&& var2.charAt(var2.length() - 1) >= 48
	...
	public final synchronized void paint(Graphics var1) {
		if (!aBool5626) {
			...
			if (Class255.time((byte) 24) - aLong5609 * 7003511818984948745L > 1000L) {
				...
				if (var2 == null
						|| var2.width >= 1405944805 * Class332.anInt3505
						&& var2.height >= Class586.anInt7792 * 542147681) {
					aBool5608 = true;
				}
			}
	...
	public void stop() {
		if (!aBool5626) {
			aLong5625 = (Class255.time((byte) 24) + 4000L)
					* -1101171135082973491L;
		}
	}
	...
	synchronized void method5962(String var1) {
		...
		Class242.aFrame2454.setSize(Class332.anInt3505 * 1405944805 + var2.left
				+ var2.right, 542147681 * Class586.anInt7792 + var2.top
				+ var2.bottom);
	}
	...
	void method5963(String var1, int var2) {
		if (!this.aBool5616) {
			...
			if (JOptionPane.showConfirmDialog(Launcher.nocturneFrame,
					"error_game_" + var1 + "\n\nWould you like to exit?",
					"Error", 0, JOptionPane.ERROR_MESSAGE) == 0) {
				System.exit(-1);
			}
			try {
				Class53.method968(Class492.anApplet5526, "loggedout",
						-451212906);
			...
			try {
				Class492.anApplet5526.getAppletContext().showDocument(
						new URL(Class492.anApplet5526.getCodeBase(),
								"error_game_" + var1 + ".ws"), "_top");
	...
	void method5968(Container var1, byte var2) {
		...
		Class425.aCanvas4798.setSize(1895615023 * Class566.anInt7611,
				Class526_Sub24.anInt10549 * 974996221);
		Class425.aCanvas4798.setVisible(true);
		if (var1 == Class242.aFrame2454) {
			Insets var3 = Class242.aFrame2454.getInsets();
			Class425.aCanvas4798.setLocation(anInt5594 * -1115728897
					+ var3.left, var3.top + anInt5605 * 1208004069);
		} else {
			Class425.aCanvas4798.setLocation(anInt5594 * -1115728897,
					anInt5605 * 1208004069);
		}
	...
	void method5988() {
		if (null != Class484.aString5485) {
			...
			if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
				...
				if (var2.equals("1.1") || var2.startsWith("1.1.")
						|| var2.equals("1.2") || var2.startsWith("1.2.")
						|| var2.equals("1.3") || var2.startsWith("1.3.")
						|| var2.equals("1.4") || var2.startsWith("1.4.")
						|| var2.equals("1.5") || var2.startsWith("1.5.")
						|| var2.equals("1.6.0")) {
				...
				if (var2.startsWith("1.6.0_")) {
					int var3;
					for (var3 = 6; var3 < var2.length()
							&& Class593.method7030(var2.charAt(var3),
									-584166481); ++var3) {
						;
					}

					String var4 = var2.substring(6, var3);
					if (Class620.method7346(var4, 914412867)
							&& Class661.method7925(var4, (byte) 71) < 10) {
		...
		while (0L == aLong5625 * 4962512506555704837L
				|| Class255.time((byte) 24) < aLong5625 * 4962512506555704837L) {
			anInt5630 = Class593.aClass513_7819.method6189(aLong5602
					* -3030308582349352637L) * 212032041;
	...
	void method5989() {
		...
		if ((anInt5607 += 537723307) * -86642429 - 1 > 50) {
			...
			aBool5606 = true;
			Class425.aCanvas4798.setSize(Class566.anInt7611 * 1895615023,
					974996221 * Class526_Sub24.anInt10549);
			Class425.aCanvas4798.setVisible(true);
			if (Class242.aFrame2454 != null && aFrame5603 == null) {
				Insets var8 = Class242.aFrame2454.getInsets();
				Class425.aCanvas4798.setLocation(var8.left + -1115728897
						* anInt5594, var8.top + 1208004069 * anInt5605);
			} else {
				Class425.aCanvas4798.setLocation(-1115728897 * anInt5594,
						1208004069 * anInt5605);
			}
		}
	...
	void method5995(byte var1) {
		...
		if ((anInt5607 += 537723307) * -86642429 - 1 > 50) {
			...
			if (Class242.aFrame2454 != null && aFrame5603 == null) {
				...
				Class425.aCanvas4798.setLocation(var9.left + -1115728897
						* anInt5594, var9.top + 1208004069 * anInt5605);
			} else {
				Class425.aCanvas4798.setLocation(-1115728897 * anInt5594,
						1208004069 * anInt5605);
			}
	...
	final void method5996(Class503 var1, String var2, String var3, int var4,
			int var5, int var6, int var7, boolean var8, short var9) {
		try {
			this.method6003(Class504.aClass504_5649, var8, (byte) 106);
			Class332.anInt3505 = (Class566.anInt7611 = var1
					.method6028(240129793) * 1363328207) * -618668925;
			Class586.anInt7792 = (Class526_Sub24.anInt10549 = var1
					.method6029(2020327310) * -193172907) * 237290525;
			anInt5594 = 0;
			anInt5605 = 0;
			if (Class585.method6988((byte) -18) == Class504.aClass504_5650) {
				Class332.anInt3505 += -1024261158
						* var1.method6030(-1908785408);
	...
	void method5997(int var1) {
		if (null != Class484.aString5485) {
			...
			if (var2.indexOf("sun") != -1 || var2.indexOf("apple") != -1) {
				...
				if (var3.equals("1.1") || var3.startsWith("1.1.")
						|| var3.equals("1.2") || var3.startsWith("1.2.")
						|| var3.equals("1.3") || var3.startsWith("1.3.")
						|| var3.equals("1.4") || var3.startsWith("1.4.")
						|| var3.equals("1.5") || var3.startsWith("1.5.")
						|| var3.equals("1.6.0")) {
				...
				if (var3.startsWith("1.6.0_")) {
					int var4;
					for (var4 = 6; var4 < var3.length()
							&& Class593.method7030(var3.charAt(var4),
									-1202916796); ++var4) {
						;
					}

					String var5 = var3.substring(6, var4);
					if (Class620.method7346(var5, -1975237408)
							&& Class661.method7925(var5, (byte) 111) < 10) {
	...
	void method6003(Class504 var1, boolean var2, byte var3) {
		...
		} else if (var1 != Class504.aClass504_5649
				&& Class504.aClass504_5648 != var1) {
	...
	public static void method6007(int var0, int var1, int var2, int var3,
			int var4) {
		Class526_Sub18 var5;
		for (var5 = (Class526_Sub18) Class526_Sub18.aClass702_10505
				.method8206((byte) 25); null != var5; var5 = (Class526_Sub18) Class526_Sub18.aClass702_10505
				.method8181(1450866210)) {
		...
		int var9;
		Class446 var12;
		for (var5 = (Class526_Sub18) Class526_Sub18.aClass702_10482
				.method8206((byte) 18); var5 != null; var5 = (Class526_Sub18) Class526_Sub18.aClass702_10482
				.method8181(384317500)) {
			var6 = 1;
			var7 = var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495
					.method10786(-16777216);
			var8 = var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495.aClass704_Sub3_11914
					.method8220(-1793767494);
			if (-1 != var8
					&& !var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495.aClass704_Sub3_11914.aBool10969) {
				if (var8 != 1317568909 * var7.runAnimation
						&& var8 != var7.runRotate180Animation * -1340587369
						&& var7.runRotate90CounterAnimation * 84725405 != var8
						&& 1443182969 * var7.runRotate90Animation != var8) {
					if (var8 == var7.moveType1Anim * 455141683
							|| var8 == var7.type1_180 * -566579917
							|| var8 == -2093545587 * var7.type1_90_counter
							|| var8 == -721906563 * var7.type1_90) {
						var6 = 3;
					}
				} else {
					var6 = 2;
			...
			if (var6 != 1820686807 * var5.anInt10486) {
				var9 = Class99.method1282(
						var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495, -1922353248);
				NPCDef var10 = var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495.def;
				if (null != var10.morphisms) {
					var10 = var10.method4049(Class242.aClass94_2456,
							Class242.aClass94_2456, 182793117);
				}
					...
					if (var5.anInt10508 * 1520182179 != var9) {
						...
						if (null != var5.aClass482_10506) {
							...
							if (var5.anInt10493 * 618519205 <= 0) {
								var5.aClass482_10506
										.method5770(100, -938617916);
								Class570.aClass231_7657.method3204(
										var5.aClass482_10506, 1995114575);
			...
			var5.anInt10487 = ((int) var12.aFloat4917 + (var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495
					.method10781(-627148024) << 8)) * -119810509;
			var5.anInt10480 = (int) var12.aFloat4919 * -967064791;
			var5.anInt10509 = ((int) var12.aFloat4919 + (var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495
					.method10781(-627148024) << 8)) * -1425665381;
			var5.anInt10484 = 435094121 * var5.aClass639_Sub1_Sub2_Sub1_Sub2_10495.aByte10827;
			Class665.method7952(var5, var0, var1, var2, var3, (byte) 0);
		}

		for (var5 = (Class526_Sub18) Class526_Sub18.aClass20_10483
				.method638(328636832); null != var5; var5 = (Class526_Sub18) Class526_Sub18.aClass20_10483
				.method639(2038204079)) {
			var6 = 1;
			var7 = var5.aClass639_Sub1_Sub2_Sub1_Sub1_10496
					.method10786(-16777216);
			var8 = var5.aClass639_Sub1_Sub2_Sub1_Sub1_10496.aClass704_Sub3_11914
					.method8220(-1289092162);
			if (var8 != -1
					&& !var5.aClass639_Sub1_Sub2_Sub1_Sub1_10496.aClass704_Sub3_11914.aBool10969) {
				if (var8 != 1317568909 * var7.runAnimation
						&& -1340587369 * var7.runRotate180Animation != var8
						&& var8 != 84725405 * var7.runRotate90CounterAnimation
						&& var7.runRotate90Animation * 1443182969 != var8) {
					if (455141683 * var7.moveType1Anim == var8
							|| var8 == var7.type1_180 * -566579917
							|| var7.type1_90_counter * -2093545587 == var8
							|| -721906563 * var7.type1_90 == var8) {
						var6 = 3;
					}
				} else {
					var6 = 2;
			...
			if (var6 != var5.anInt10486 * 1820686807) {
				var9 = Class149_Sub1.method8355(
						var5.aClass639_Sub1_Sub2_Sub1_Sub1_10496, 811221711);
				if (1520182179 * var5.anInt10508 != var9) {
					...
					if (null != var5.aClass482_10506) {
						...
						if (618519205 * var5.anInt10493 <= 0) {
							...
							Class570.aClass231_7657.method3204(
									var5.aClass482_10506, 1085088123);
							var5.aClass482_10506 = null;
							var13 = true;
						}
					} else {
			...
			var5.anInt10487 = ((int) var12.aFloat4917 + (var5.aClass639_Sub1_Sub2_Sub1_Sub1_10496
					.method10781(-627148024) << 8)) * -119810509;
			var5.anInt10480 = (int) var12.aFloat4919 * -967064791;
			var5.anInt10509 = ((int) var12.aFloat4919 + (var5.aClass639_Sub1_Sub2_Sub1_Sub1_10496
					.method10781(-627148024) << 8)) * -1425665381;
	...
	static final void method6009(Class681 var0, int var1) {
		...
		int var5 = var3 >>> 8;
		int var6 = var3 & 255;
		Class18 var7 = (Class18) Class219.aClass40_2294.method89(var2,
				-847200527);
		Class77 var8 = (Class77) Class304_Sub1.aClass40_10066.method89(var5,
				-771404093);
