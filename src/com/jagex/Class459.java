...
public class Class459 {
	...
	Class459(RSByteBuffer var1, BigInteger var2, BigInteger var3) {
		...
		if(65 != var6.length && 64 != var6.length) {
			...
			if (!RS3Applet.RSPS) {
				byte[] var14 = Class200.method2872(var1.buffer, 5, 301018015 * var1.pos - var5.length - 5, -1542931636);
			...
			for(int var15 = 0; var15 < var4; ++var15) {
				...
				this.aClass469Array5171[var15] = new Class469(var9, var11, var10, var12, var13);
			}
	...
	static boolean method5421(TwitchEvent var0, long var1) {
		...
		if(var0.eventType == 33) {
			if(Class570.aTwitchWebcamFrameData7647 == null) {
				...
				int var4 = Class570.aTwitchTV7639.GetWebcamFrameData(var3, Class570.aTwitchWebcamFrameData7647);
				if(0 == var4) {
	...
	static final void method5423(Class681 var0, int var1) {
		...
		int var6;
		for(var6 = 0; var6 < 10 && var0.anIntArray8622[var6 + var0.anInt8623 * -1730576285] >= 0; var6 += 2) {
			;
		}
		...
		if(var6 > 0) {
			...
			for(var6 -= 2; var6 >= 0; var6 -= 2) {
				var4[var6 / 2] = (byte)var0.anIntArray8622[var6 + var0.anInt8623 * -1730576285];
				var5[var6 / 2] = (byte)var0.anIntArray8622[1 + var6 + var0.anInt8623 * -1730576285];
			}
		}
